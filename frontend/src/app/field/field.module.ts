...
@NgModule({
  declarations: [FieldComponent, AddActorDialogComponent, DeleteActorDialogComponent, DeleteRotationDialogComponent, AddRotationDialogComponent],
  imports: [FieldRoutingModule, SharedModule, TranslateModule, MatDialogModule, ReactiveFormsModule, CommonModule, MatCheckboxModule],
})
